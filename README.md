...
- [ ] Explain what a token is used for.
  ...
  A token is a unique key that is given to each user upon logging in. This token is used to authenticate the given user and allows access to other parts of the site like PrivateRoutes

- [ ] What steps can you take in your web apps to keep your data secure?

  PrivateRoutes/tokens are a good start. Backing up data and using third-party data security.

- [ ] Describe how web servers work.

  A web server is a hardware or software that's dedicated to running software. It also processes HTTP requests like stated below.

* [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

CRUD stands for: create, read, update, delete.

In that same order, we use: .get, .put, .post, .delete.
